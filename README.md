# borgius/node docker image

[![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:latest.svg)](https://microbadger.com/images/borgius/node) [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2Flatest)](http://travis-ci.org/borgius/node.docker)
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:6.3.1.svg) `borgius/node-alpine:6.3.1`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:6.1.0-development.svg) `borgius/node-alpine:6.1.0-development`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:5.10.0.svg) `borgius/node-alpine:5.10.0`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:5.7.0-development.svg) `borgius/node-alpine:5.7.0-development`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:5.2.0.svg) `borgius/node-alpine:5.2.0`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:4.4.6-development.svg) `borgius/node-alpine:4.4.6-development`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:4.4.0.svg) `borgius/node-alpine:4.4.0`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:4.2.5-development.svg) `borgius/node-alpine:4.2.5-development`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:4.1.2.svg) `borgius/node-alpine:4.1.2`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.12.14-development.svg) `borgius/node-alpine:0.12.14-development`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.12.8.svg) `borgius/node-alpine:0.12.8`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.12.3-development.svg) `borgius/node-alpine:0.12.3-development`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.11.14.svg) `borgius/node-alpine:0.11.14`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.11.9-development.svg) `borgius/node-alpine:0.11.9-development`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.11.3.svg) `borgius/node-alpine:0.11.3`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.10.45-development.svg) `borgius/node-alpine:0.10.45-development`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.10.39.svg) `borgius/node-alpine:0.10.39`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.10.34-development.svg) `borgius/node-alpine:0.10.34-development`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.10.28.svg) `borgius/node-alpine:0.10.28`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.10.23-development.svg) `borgius/node-alpine:0.10.23-development`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.10.17.svg) `borgius/node-alpine:0.10.17`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.10.12-development.svg) `borgius/node-alpine:0.10.12-development`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.10.6.svg) `borgius/node-alpine:0.10.6`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.10.1-development.svg) `borgius/node-alpine:0.10.1-development`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.9.8.svg) `borgius/node-alpine:0.9.8`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.9.3-development.svg) `borgius/node-alpine:0.9.3-development`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.26.svg) `borgius/node-alpine:0.8.26`
...
![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.24-onbuild.svg) `borgius/node-alpine:0.8.24-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.24-development.svg) `borgius/node-alpine:0.8.24-development`


* **0.8.23** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.23)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.23.svg) `borgius/node-alpine:0.8.23`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.23-onbuild.svg) `borgius/node-alpine:0.8.23-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.23-development.svg) `borgius/node-alpine:0.8.23-development`


* **0.8.22** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.22)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.22.svg) `borgius/node-alpine:0.8.22`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.22-onbuild.svg) `borgius/node-alpine:0.8.22-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.22-development.svg) `borgius/node-alpine:0.8.22-development`


* **0.8.21** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.21)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.21.svg) `borgius/node-alpine:0.8.21`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.21-onbuild.svg) `borgius/node-alpine:0.8.21-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.21-development.svg) `borgius/node-alpine:0.8.21-development`


* **0.8.20** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.20)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.20.svg) `borgius/node-alpine:0.8.20`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.20-onbuild.svg) `borgius/node-alpine:0.8.20-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.20-development.svg) `borgius/node-alpine:0.8.20-development`


* **0.8.19** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.19)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.19.svg) `borgius/node-alpine:0.8.19`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.19-onbuild.svg) `borgius/node-alpine:0.8.19-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.19-development.svg) `borgius/node-alpine:0.8.19-development`


* **0.8.18** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.18)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.18.svg) `borgius/node-alpine:0.8.18`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.18-onbuild.svg) `borgius/node-alpine:0.8.18-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.18-development.svg) `borgius/node-alpine:0.8.18-development`


* **0.8.17** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.17)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.17.svg) `borgius/node-alpine:0.8.17`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.17-onbuild.svg) `borgius/node-alpine:0.8.17-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.17-development.svg) `borgius/node-alpine:0.8.17-development`


* **0.8.16** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.16)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.16.svg) `borgius/node-alpine:0.8.16`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.16-onbuild.svg) `borgius/node-alpine:0.8.16-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.16-development.svg) `borgius/node-alpine:0.8.16-development`


* **0.8.15** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.15)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.15.svg) `borgius/node-alpine:0.8.15`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.15-onbuild.svg) `borgius/node-alpine:0.8.15-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.15-development.svg) `borgius/node-alpine:0.8.15-development`


* **0.8.14** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.14)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.14.svg) `borgius/node-alpine:0.8.14`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.14-onbuild.svg) `borgius/node-alpine:0.8.14-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.14-development.svg) `borgius/node-alpine:0.8.14-development`


* **0.8.13** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.13)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.13.svg) `borgius/node-alpine:0.8.13`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.13-onbuild.svg) `borgius/node-alpine:0.8.13-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.13-development.svg) `borgius/node-alpine:0.8.13-development`


* **0.8.12** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.12)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.12.svg) `borgius/node-alpine:0.8.12`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.12-onbuild.svg) `borgius/node-alpine:0.8.12-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.12-development.svg) `borgius/node-alpine:0.8.12-development`


* **0.8.11** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.11)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.11.svg) `borgius/node-alpine:0.8.11`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.11-onbuild.svg) `borgius/node-alpine:0.8.11-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.11-development.svg) `borgius/node-alpine:0.8.11-development`


* **0.8.10** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.10)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.10.svg) `borgius/node-alpine:0.8.10`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.10-onbuild.svg) `borgius/node-alpine:0.8.10-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.10-development.svg) `borgius/node-alpine:0.8.10-development`


* **0.8.9** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.9)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.9.svg) `borgius/node-alpine:0.8.9`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.9-onbuild.svg) `borgius/node-alpine:0.8.9-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.9-development.svg) `borgius/node-alpine:0.8.9-development`


* **0.8.8** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.8)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.8.svg) `borgius/node-alpine:0.8.8`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.8-onbuild.svg) `borgius/node-alpine:0.8.8-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.8-development.svg) `borgius/node-alpine:0.8.8-development`


* **0.8.7** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.7)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.7.svg) `borgius/node-alpine:0.8.7`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.7-onbuild.svg) `borgius/node-alpine:0.8.7-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.7-development.svg) `borgius/node-alpine:0.8.7-development`


* **0.8.6** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.6)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.6.svg) `borgius/node-alpine:0.8.6`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.6-onbuild.svg) `borgius/node-alpine:0.8.6-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.6-development.svg) `borgius/node-alpine:0.8.6-development`


* **0.8.5** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.5)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.5.svg) `borgius/node-alpine:0.8.5`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.5-onbuild.svg) `borgius/node-alpine:0.8.5-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.5-development.svg) `borgius/node-alpine:0.8.5-development`


* **0.8.4** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.4)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.4.svg) `borgius/node-alpine:0.8.4`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.4-onbuild.svg) `borgius/node-alpine:0.8.4-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.4-development.svg) `borgius/node-alpine:0.8.4-development`


* **0.8.3** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.3)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.3.svg) `borgius/node-alpine:0.8.3`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.3-onbuild.svg) `borgius/node-alpine:0.8.3-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.3-development.svg) `borgius/node-alpine:0.8.3-development`


* **0.8.2** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.2)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.2.svg) `borgius/node-alpine:0.8.2`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.2-onbuild.svg) `borgius/node-alpine:0.8.2-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.2-development.svg) `borgius/node-alpine:0.8.2-development`


* **0.8.1** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.1)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.1.svg) `borgius/node-alpine:0.8.1`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.1-onbuild.svg) `borgius/node-alpine:0.8.1-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.1-development.svg) `borgius/node-alpine:0.8.1-development`


* **0.8.0** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.8.0)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.0.svg) `borgius/node-alpine:0.8.0`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.0-onbuild.svg) `borgius/node-alpine:0.8.0-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.8.0-development.svg) `borgius/node-alpine:0.8.0-development`


* **0.7.12** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.7.12)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.12.svg) `borgius/node-alpine:0.7.12`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.12-onbuild.svg) `borgius/node-alpine:0.7.12-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.12-development.svg) `borgius/node-alpine:0.7.12-development`


* **0.7.11** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.7.11)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.11.svg) `borgius/node-alpine:0.7.11`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.11-onbuild.svg) `borgius/node-alpine:0.7.11-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.11-development.svg) `borgius/node-alpine:0.7.11-development`


* **0.7.10** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.7.10)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.10.svg) `borgius/node-alpine:0.7.10`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.10-onbuild.svg) `borgius/node-alpine:0.7.10-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.10-development.svg) `borgius/node-alpine:0.7.10-development`


* **0.7.9** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.7.9)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.9.svg) `borgius/node-alpine:0.7.9`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.9-onbuild.svg) `borgius/node-alpine:0.7.9-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.9-development.svg) `borgius/node-alpine:0.7.9-development`


* **0.7.8** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.7.8)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.8.svg) `borgius/node-alpine:0.7.8`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.8-onbuild.svg) `borgius/node-alpine:0.7.8-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.8-development.svg) `borgius/node-alpine:0.7.8-development`


* **0.7.7** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.7.7)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.7.svg) `borgius/node-alpine:0.7.7`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.7-onbuild.svg) `borgius/node-alpine:0.7.7-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.7-development.svg) `borgius/node-alpine:0.7.7-development`


* **0.7.6** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.7.6)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.6.svg) `borgius/node-alpine:0.7.6`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.6-onbuild.svg) `borgius/node-alpine:0.7.6-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.6-development.svg) `borgius/node-alpine:0.7.6-development`


* **0.7.5** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.7.5)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.5.svg) `borgius/node-alpine:0.7.5`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.5-onbuild.svg) `borgius/node-alpine:0.7.5-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.5-development.svg) `borgius/node-alpine:0.7.5-development`


* **0.7.4** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.7.4)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.4.svg) `borgius/node-alpine:0.7.4`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.4-onbuild.svg) `borgius/node-alpine:0.7.4-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.4-development.svg) `borgius/node-alpine:0.7.4-development`


* **0.7.3** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.7.3)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.3.svg) `borgius/node-alpine:0.7.3`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.3-onbuild.svg) `borgius/node-alpine:0.7.3-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.3-development.svg) `borgius/node-alpine:0.7.3-development`


* **0.7.2** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.7.2)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.2.svg) `borgius/node-alpine:0.7.2`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.2-onbuild.svg) `borgius/node-alpine:0.7.2-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.2-development.svg) `borgius/node-alpine:0.7.2-development`


* **0.7.1** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.7.1)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.1.svg) `borgius/node-alpine:0.7.1`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.1-onbuild.svg) `borgius/node-alpine:0.7.1-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.1-development.svg) `borgius/node-alpine:0.7.1-development`


* **0.7.0** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.7.0)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.0.svg) `borgius/node-alpine:0.7.0`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.0-onbuild.svg) `borgius/node-alpine:0.7.0-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.7.0-development.svg) `borgius/node-alpine:0.7.0-development`


* **0.6.21** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.21)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.21.svg) `borgius/node-alpine:0.6.21`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.21-onbuild.svg) `borgius/node-alpine:0.6.21-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.21-development.svg) `borgius/node-alpine:0.6.21-development`


* **0.6.20** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.20)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.20.svg) `borgius/node-alpine:0.6.20`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.20-onbuild.svg) `borgius/node-alpine:0.6.20-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.20-development.svg) `borgius/node-alpine:0.6.20-development`


* **0.6.19** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.19)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.19.svg) `borgius/node-alpine:0.6.19`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.19-onbuild.svg) `borgius/node-alpine:0.6.19-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.19-development.svg) `borgius/node-alpine:0.6.19-development`


* **0.6.18** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.18)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.18.svg) `borgius/node-alpine:0.6.18`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.18-onbuild.svg) `borgius/node-alpine:0.6.18-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.18-development.svg) `borgius/node-alpine:0.6.18-development`


* **0.6.17** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.17)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.17.svg) `borgius/node-alpine:0.6.17`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.17-onbuild.svg) `borgius/node-alpine:0.6.17-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.17-development.svg) `borgius/node-alpine:0.6.17-development`


* **0.6.16** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.16)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.16.svg) `borgius/node-alpine:0.6.16`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.16-onbuild.svg) `borgius/node-alpine:0.6.16-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.16-development.svg) `borgius/node-alpine:0.6.16-development`


* **0.6.15** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.15)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.15.svg) `borgius/node-alpine:0.6.15`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.15-onbuild.svg) `borgius/node-alpine:0.6.15-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.15-development.svg) `borgius/node-alpine:0.6.15-development`


* **0.6.14** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.14)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.14.svg) `borgius/node-alpine:0.6.14`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.14-onbuild.svg) `borgius/node-alpine:0.6.14-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.14-development.svg) `borgius/node-alpine:0.6.14-development`


* **0.6.13** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.13)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.13.svg) `borgius/node-alpine:0.6.13`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.13-onbuild.svg) `borgius/node-alpine:0.6.13-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.13-development.svg) `borgius/node-alpine:0.6.13-development`


* **0.6.12** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.12)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.12.svg) `borgius/node-alpine:0.6.12`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.12-onbuild.svg) `borgius/node-alpine:0.6.12-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.12-development.svg) `borgius/node-alpine:0.6.12-development`


* **0.6.11** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.11)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.11.svg) `borgius/node-alpine:0.6.11`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.11-onbuild.svg) `borgius/node-alpine:0.6.11-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.11-development.svg) `borgius/node-alpine:0.6.11-development`


* **0.6.10** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.10)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.10.svg) `borgius/node-alpine:0.6.10`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.10-onbuild.svg) `borgius/node-alpine:0.6.10-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.10-development.svg) `borgius/node-alpine:0.6.10-development`


* **0.6.9** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.9)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.9.svg) `borgius/node-alpine:0.6.9`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.9-onbuild.svg) `borgius/node-alpine:0.6.9-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.9-development.svg) `borgius/node-alpine:0.6.9-development`


* **0.6.8** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.8)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.8.svg) `borgius/node-alpine:0.6.8`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.8-onbuild.svg) `borgius/node-alpine:0.6.8-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.8-development.svg) `borgius/node-alpine:0.6.8-development`


* **0.6.7** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.7)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.7.svg) `borgius/node-alpine:0.6.7`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.7-onbuild.svg) `borgius/node-alpine:0.6.7-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.7-development.svg) `borgius/node-alpine:0.6.7-development`


* **0.6.6** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.6)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.6.svg) `borgius/node-alpine:0.6.6`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.6-onbuild.svg) `borgius/node-alpine:0.6.6-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.6-development.svg) `borgius/node-alpine:0.6.6-development`


* **0.6.5** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.5)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.5.svg) `borgius/node-alpine:0.6.5`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.5-onbuild.svg) `borgius/node-alpine:0.6.5-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.5-development.svg) `borgius/node-alpine:0.6.5-development`


* **0.6.4** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.4)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.4.svg) `borgius/node-alpine:0.6.4`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.4-onbuild.svg) `borgius/node-alpine:0.6.4-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.4-development.svg) `borgius/node-alpine:0.6.4-development`


* **0.6.3** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.3)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.3.svg) `borgius/node-alpine:0.6.3`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.3-onbuild.svg) `borgius/node-alpine:0.6.3-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.3-development.svg) `borgius/node-alpine:0.6.3-development`


* **0.6.2** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.2)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.2.svg) `borgius/node-alpine:0.6.2`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.2-onbuild.svg) `borgius/node-alpine:0.6.2-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.2-development.svg) `borgius/node-alpine:0.6.2-development`


* **0.6.1** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.1)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.1.svg) `borgius/node-alpine:0.6.1`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.1-onbuild.svg) `borgius/node-alpine:0.6.1-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.1-development.svg) `borgius/node-alpine:0.6.1-development`


* **0.6.0** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.6.0)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.0.svg) `borgius/node-alpine:0.6.0`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.0-onbuild.svg) `borgius/node-alpine:0.6.0-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.6.0-development.svg) `borgius/node-alpine:0.6.0-development`


* **0.5.10** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.5.10)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.10.svg) `borgius/node-alpine:0.5.10`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.10-onbuild.svg) `borgius/node-alpine:0.5.10-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.10-development.svg) `borgius/node-alpine:0.5.10-development`


* **0.5.9** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.5.9)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.9.svg) `borgius/node-alpine:0.5.9`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.9-onbuild.svg) `borgius/node-alpine:0.5.9-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.9-development.svg) `borgius/node-alpine:0.5.9-development`


* **0.5.8** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.5.8)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.8.svg) `borgius/node-alpine:0.5.8`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.8-onbuild.svg) `borgius/node-alpine:0.5.8-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.8-development.svg) `borgius/node-alpine:0.5.8-development`


* **0.5.7** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.5.7)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.7.svg) `borgius/node-alpine:0.5.7`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.7-onbuild.svg) `borgius/node-alpine:0.5.7-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.7-development.svg) `borgius/node-alpine:0.5.7-development`


* **0.5.6** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.5.6)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.6.svg) `borgius/node-alpine:0.5.6`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.6-onbuild.svg) `borgius/node-alpine:0.5.6-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.6-development.svg) `borgius/node-alpine:0.5.6-development`


* **0.5.5** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.5.5)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.5.svg) `borgius/node-alpine:0.5.5`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.5-onbuild.svg) `borgius/node-alpine:0.5.5-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.5-development.svg) `borgius/node-alpine:0.5.5-development`


* **0.5.4** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.5.4)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.4.svg) `borgius/node-alpine:0.5.4`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.4-onbuild.svg) `borgius/node-alpine:0.5.4-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.4-development.svg) `borgius/node-alpine:0.5.4-development`


* **0.5.3** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.5.3)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.3.svg) `borgius/node-alpine:0.5.3`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.3-onbuild.svg) `borgius/node-alpine:0.5.3-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.3-development.svg) `borgius/node-alpine:0.5.3-development`


* **0.5.2** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.5.2)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.2.svg) `borgius/node-alpine:0.5.2`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.2-onbuild.svg) `borgius/node-alpine:0.5.2-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.2-development.svg) `borgius/node-alpine:0.5.2-development`


* **0.5.1** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.5.1)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.1.svg) `borgius/node-alpine:0.5.1`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.1-onbuild.svg) `borgius/node-alpine:0.5.1-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.1-development.svg) `borgius/node-alpine:0.5.1-development`


* **0.5.0** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.5.0)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.0.svg) `borgius/node-alpine:0.5.0`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.0-onbuild.svg) `borgius/node-alpine:0.5.0-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.5.0-development.svg) `borgius/node-alpine:0.5.0-development`


* **0.4.12** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.4.12)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.12.svg) `borgius/node-alpine:0.4.12`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.12-onbuild.svg) `borgius/node-alpine:0.4.12-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.12-development.svg) `borgius/node-alpine:0.4.12-development`


* **0.4.11** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.4.11)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.11.svg) `borgius/node-alpine:0.4.11`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.11-onbuild.svg) `borgius/node-alpine:0.4.11-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.11-development.svg) `borgius/node-alpine:0.4.11-development`


* **0.4.10** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.4.10)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.10.svg) `borgius/node-alpine:0.4.10`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.10-onbuild.svg) `borgius/node-alpine:0.4.10-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.10-development.svg) `borgius/node-alpine:0.4.10-development`


* **0.4.9** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.4.9)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.9.svg) `borgius/node-alpine:0.4.9`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.9-onbuild.svg) `borgius/node-alpine:0.4.9-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.9-development.svg) `borgius/node-alpine:0.4.9-development`


* **0.4.8** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.4.8)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.8.svg) `borgius/node-alpine:0.4.8`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.8-onbuild.svg) `borgius/node-alpine:0.4.8-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.8-development.svg) `borgius/node-alpine:0.4.8-development`


* **0.4.7** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.4.7)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.7.svg) `borgius/node-alpine:0.4.7`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.7-onbuild.svg) `borgius/node-alpine:0.4.7-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.7-development.svg) `borgius/node-alpine:0.4.7-development`


* **0.4.6** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.4.6)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.6.svg) `borgius/node-alpine:0.4.6`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.6-onbuild.svg) `borgius/node-alpine:0.4.6-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.6-development.svg) `borgius/node-alpine:0.4.6-development`


* **0.4.5** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.4.5)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.5.svg) `borgius/node-alpine:0.4.5`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.5-onbuild.svg) `borgius/node-alpine:0.4.5-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.5-development.svg) `borgius/node-alpine:0.4.5-development`


* **0.4.4** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.4.4)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.4.svg) `borgius/node-alpine:0.4.4`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.4-onbuild.svg) `borgius/node-alpine:0.4.4-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.4-development.svg) `borgius/node-alpine:0.4.4-development`


* **0.4.3** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.4.3)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.3.svg) `borgius/node-alpine:0.4.3`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.3-onbuild.svg) `borgius/node-alpine:0.4.3-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.3-development.svg) `borgius/node-alpine:0.4.3-development`


* **0.4.2** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.4.2)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.2.svg) `borgius/node-alpine:0.4.2`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.2-onbuild.svg) `borgius/node-alpine:0.4.2-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.2-development.svg) `borgius/node-alpine:0.4.2-development`


* **0.4.1** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.4.1)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.1.svg) `borgius/node-alpine:0.4.1`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.1-onbuild.svg) `borgius/node-alpine:0.4.1-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.1-development.svg) `borgius/node-alpine:0.4.1-development`


* **0.4.0** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.4.0)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.0.svg) `borgius/node-alpine:0.4.0`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.0-onbuild.svg) `borgius/node-alpine:0.4.0-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.4.0-development.svg) `borgius/node-alpine:0.4.0-development`


* **0.3.8** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.3.8)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.8.svg) `borgius/node-alpine:0.3.8`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.8-onbuild.svg) `borgius/node-alpine:0.3.8-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.8-development.svg) `borgius/node-alpine:0.3.8-development`


* **0.3.7** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.3.7)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.7.svg) `borgius/node-alpine:0.3.7`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.7-onbuild.svg) `borgius/node-alpine:0.3.7-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.7-development.svg) `borgius/node-alpine:0.3.7-development`


* **0.3.6** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.3.6)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.6.svg) `borgius/node-alpine:0.3.6`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.6-onbuild.svg) `borgius/node-alpine:0.3.6-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.6-development.svg) `borgius/node-alpine:0.3.6-development`


* **0.3.5** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.3.5)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.5.svg) `borgius/node-alpine:0.3.5`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.5-onbuild.svg) `borgius/node-alpine:0.3.5-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.5-development.svg) `borgius/node-alpine:0.3.5-development`


* **0.3.4** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.3.4)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.4.svg) `borgius/node-alpine:0.3.4`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.4-onbuild.svg) `borgius/node-alpine:0.3.4-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.4-development.svg) `borgius/node-alpine:0.3.4-development`


* **0.3.3** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.3.3)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.3.svg) `borgius/node-alpine:0.3.3`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.3-onbuild.svg) `borgius/node-alpine:0.3.3-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.3-development.svg) `borgius/node-alpine:0.3.3-development`


* **0.3.2** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.3.2)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.2.svg) `borgius/node-alpine:0.3.2`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.2-onbuild.svg) `borgius/node-alpine:0.3.2-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.2-development.svg) `borgius/node-alpine:0.3.2-development`


* **0.3.1** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.3.1)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.1.svg) `borgius/node-alpine:0.3.1`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.1-onbuild.svg) `borgius/node-alpine:0.3.1-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.1-development.svg) `borgius/node-alpine:0.3.1-development`


* **0.3.0** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.3.0)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.0.svg) `borgius/node-alpine:0.3.0`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.0-onbuild.svg) `borgius/node-alpine:0.3.0-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.3.0-development.svg) `borgius/node-alpine:0.3.0-development`


* **0.2.6** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.2.6)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.6.svg) `borgius/node-alpine:0.2.6`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.6-onbuild.svg) `borgius/node-alpine:0.2.6-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.6-development.svg) `borgius/node-alpine:0.2.6-development`


* **0.2.5** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.2.5)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.5.svg) `borgius/node-alpine:0.2.5`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.5-onbuild.svg) `borgius/node-alpine:0.2.5-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.5-development.svg) `borgius/node-alpine:0.2.5-development`


* **0.2.4** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.2.4)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.4.svg) `borgius/node-alpine:0.2.4`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.4-onbuild.svg) `borgius/node-alpine:0.2.4-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.4-development.svg) `borgius/node-alpine:0.2.4-development`


* **0.2.3** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.2.3)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.3.svg) `borgius/node-alpine:0.2.3`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.3-onbuild.svg) `borgius/node-alpine:0.2.3-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.3-development.svg) `borgius/node-alpine:0.2.3-development`


* **0.2.2** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.2.2)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.2.svg) `borgius/node-alpine:0.2.2`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.2-onbuild.svg) `borgius/node-alpine:0.2.2-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.2-development.svg) `borgius/node-alpine:0.2.2-development`


* **0.2.1** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.2.1)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.1.svg) `borgius/node-alpine:0.2.1`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.1-onbuild.svg) `borgius/node-alpine:0.2.1-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.1-development.svg) `borgius/node-alpine:0.2.1-development`


* **0.2.0** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.2.0)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.0.svg) `borgius/node-alpine:0.2.0`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.0-onbuild.svg) `borgius/node-alpine:0.2.0-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.2.0-development.svg) `borgius/node-alpine:0.2.0-development`


* **0.1.104** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.104)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.104.svg) `borgius/node-alpine:0.1.104`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.104-onbuild.svg) `borgius/node-alpine:0.1.104-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.104-development.svg) `borgius/node-alpine:0.1.104-development`


* **0.1.103** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.103)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.103.svg) `borgius/node-alpine:0.1.103`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.103-onbuild.svg) `borgius/node-alpine:0.1.103-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.103-development.svg) `borgius/node-alpine:0.1.103-development`


* **0.1.102** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.102)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.102.svg) `borgius/node-alpine:0.1.102`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.102-onbuild.svg) `borgius/node-alpine:0.1.102-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.102-development.svg) `borgius/node-alpine:0.1.102-development`


* **0.1.101** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.101)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.101.svg) `borgius/node-alpine:0.1.101`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.101-onbuild.svg) `borgius/node-alpine:0.1.101-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.101-development.svg) `borgius/node-alpine:0.1.101-development`


* **0.1.100** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.100)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.100.svg) `borgius/node-alpine:0.1.100`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.100-onbuild.svg) `borgius/node-alpine:0.1.100-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.100-development.svg) `borgius/node-alpine:0.1.100-development`


* **0.1.99** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.99)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.99.svg) `borgius/node-alpine:0.1.99`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.99-onbuild.svg) `borgius/node-alpine:0.1.99-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.99-development.svg) `borgius/node-alpine:0.1.99-development`


* **0.1.98** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.98)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.98.svg) `borgius/node-alpine:0.1.98`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.98-onbuild.svg) `borgius/node-alpine:0.1.98-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.98-development.svg) `borgius/node-alpine:0.1.98-development`


* **0.1.97** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.97)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.97.svg) `borgius/node-alpine:0.1.97`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.97-onbuild.svg) `borgius/node-alpine:0.1.97-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.97-development.svg) `borgius/node-alpine:0.1.97-development`


* **0.1.96** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.96)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.96.svg) `borgius/node-alpine:0.1.96`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.96-onbuild.svg) `borgius/node-alpine:0.1.96-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.96-development.svg) `borgius/node-alpine:0.1.96-development`


* **0.1.95** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.95)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.95.svg) `borgius/node-alpine:0.1.95`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.95-onbuild.svg) `borgius/node-alpine:0.1.95-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.95-development.svg) `borgius/node-alpine:0.1.95-development`


* **0.1.94** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.94)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.94.svg) `borgius/node-alpine:0.1.94`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.94-onbuild.svg) `borgius/node-alpine:0.1.94-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.94-development.svg) `borgius/node-alpine:0.1.94-development`


* **0.1.93** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.93)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.93.svg) `borgius/node-alpine:0.1.93`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.93-onbuild.svg) `borgius/node-alpine:0.1.93-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.93-development.svg) `borgius/node-alpine:0.1.93-development`


* **0.1.92** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.92)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.92.svg) `borgius/node-alpine:0.1.92`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.92-onbuild.svg) `borgius/node-alpine:0.1.92-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.92-development.svg) `borgius/node-alpine:0.1.92-development`


* **0.1.91** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.91)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.91.svg) `borgius/node-alpine:0.1.91`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.91-onbuild.svg) `borgius/node-alpine:0.1.91-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.91-development.svg) `borgius/node-alpine:0.1.91-development`


* **0.1.90** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.90)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.90.svg) `borgius/node-alpine:0.1.90`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.90-onbuild.svg) `borgius/node-alpine:0.1.90-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.90-development.svg) `borgius/node-alpine:0.1.90-development`


* **0.1.33** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.33)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.33.svg) `borgius/node-alpine:0.1.33`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.33-onbuild.svg) `borgius/node-alpine:0.1.33-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.33-development.svg) `borgius/node-alpine:0.1.33-development`


* **0.1.32** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.32)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.32.svg) `borgius/node-alpine:0.1.32`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.32-onbuild.svg) `borgius/node-alpine:0.1.32-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.32-development.svg) `borgius/node-alpine:0.1.32-development`


* **0.1.31** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.31)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.31.svg) `borgius/node-alpine:0.1.31`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.31-onbuild.svg) `borgius/node-alpine:0.1.31-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.31-development.svg) `borgius/node-alpine:0.1.31-development`


* **0.1.30** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.30)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.30.svg) `borgius/node-alpine:0.1.30`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.30-onbuild.svg) `borgius/node-alpine:0.1.30-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.30-development.svg) `borgius/node-alpine:0.1.30-development`


* **0.1.29** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.29)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.29.svg) `borgius/node-alpine:0.1.29`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.29-onbuild.svg) `borgius/node-alpine:0.1.29-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.29-development.svg) `borgius/node-alpine:0.1.29-development`


* **0.1.28** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.28)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.28.svg) `borgius/node-alpine:0.1.28`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.28-onbuild.svg) `borgius/node-alpine:0.1.28-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.28-development.svg) `borgius/node-alpine:0.1.28-development`


* **0.1.27** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.27)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.27.svg) `borgius/node-alpine:0.1.27`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.27-onbuild.svg) `borgius/node-alpine:0.1.27-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.27-development.svg) `borgius/node-alpine:0.1.27-development`


* **0.1.26** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.26)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.26.svg) `borgius/node-alpine:0.1.26`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.26-onbuild.svg) `borgius/node-alpine:0.1.26-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.26-development.svg) `borgius/node-alpine:0.1.26-development`


* **0.1.25** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.25)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.25.svg) `borgius/node-alpine:0.1.25`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.25-onbuild.svg) `borgius/node-alpine:0.1.25-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.25-development.svg) `borgius/node-alpine:0.1.25-development`


* **0.1.24** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.24)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.24.svg) `borgius/node-alpine:0.1.24`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.24-onbuild.svg) `borgius/node-alpine:0.1.24-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.24-development.svg) `borgius/node-alpine:0.1.24-development`


* **0.1.23** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.23)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.23.svg) `borgius/node-alpine:0.1.23`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.23-onbuild.svg) `borgius/node-alpine:0.1.23-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.23-development.svg) `borgius/node-alpine:0.1.23-development`


* **0.1.22** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.22)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.22.svg) `borgius/node-alpine:0.1.22`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.22-onbuild.svg) `borgius/node-alpine:0.1.22-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.22-development.svg) `borgius/node-alpine:0.1.22-development`


* **0.1.21** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.21)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.21.svg) `borgius/node-alpine:0.1.21`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.21-onbuild.svg) `borgius/node-alpine:0.1.21-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.21-development.svg) `borgius/node-alpine:0.1.21-development`


* **0.1.20** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.20)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.20.svg) `borgius/node-alpine:0.1.20`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.20-onbuild.svg) `borgius/node-alpine:0.1.20-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.20-development.svg) `borgius/node-alpine:0.1.20-development`


* **0.1.19** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.19)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.19.svg) `borgius/node-alpine:0.1.19`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.19-onbuild.svg) `borgius/node-alpine:0.1.19-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.19-development.svg) `borgius/node-alpine:0.1.19-development`


* **0.1.18** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.18)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.18.svg) `borgius/node-alpine:0.1.18`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.18-onbuild.svg) `borgius/node-alpine:0.1.18-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.18-development.svg) `borgius/node-alpine:0.1.18-development`


* **0.1.17** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.17)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.17.svg) `borgius/node-alpine:0.1.17`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.17-onbuild.svg) `borgius/node-alpine:0.1.17-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.17-development.svg) `borgius/node-alpine:0.1.17-development`


* **0.1.16** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.16)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.16.svg) `borgius/node-alpine:0.1.16`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.16-onbuild.svg) `borgius/node-alpine:0.1.16-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.16-development.svg) `borgius/node-alpine:0.1.16-development`


* **0.1.15** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.15)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.15.svg) `borgius/node-alpine:0.1.15`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.15-onbuild.svg) `borgius/node-alpine:0.1.15-onbuild`

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.15-development.svg) `borgius/node-alpine:0.1.15-development`


* **0.1.14** - [![build status](https://travis-ci.org/borgius/node.docker.svg?branch=version%2F0.1.14)](http://travis-ci.org/borgius/node.docker)

![layers](https://images.microbadger.com/badges/image/borgius/node-alpine:0.1.14.svg) `borgius/node-alpine:0.1.14`
